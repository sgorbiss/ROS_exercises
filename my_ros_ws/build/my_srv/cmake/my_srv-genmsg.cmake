...
get_filename_component(_filename "/root/my_ros_ws/src/my_srv/srv/Velocity.srv" NAME_WE)
add_custom_target(_my_srv_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "my_srv" "/root/my_ros_ws/src/my_srv/srv/Velocity.srv" ""
)
...
_generate_srv_cpp(my_srv
  "/root/my_ros_ws/src/my_srv/srv/Velocity.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_srv)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_srv\")")
  # install generated code
  install(
